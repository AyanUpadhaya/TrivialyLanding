<template>
  <div
    class="sticky top-0 w-full py-2 md:py-4 lg:py-6 z-[999] backdrop-blur-md  shadow-navShadow "
    :class="isScrolled ? 'bg-white' : 'backdrop-blur-md'"
  >
    <nav
      class="max-w-[1176px] mx-auto flex justify-between items-center gap-6 flex-wrap px-4"
    >
...
<script>
import { logo, logodark } from "../../assets/getAssets";
